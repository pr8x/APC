...
lv_obj_t *ui_MixerScreen_DeckA_TotalTimeLabel;
lv_obj_t *ui_MixerScreen_DeckA_RemaiTimeLabel;
lv_obj_t *ui_MixerScreen_DeckA_KeyLabel;
lv_obj_t *ui_MixerScreen_DeckB_RemaiTimeLabel;
...
lv_obj_set_y( ui_MixerScreen_DeckA_BPMLabel, 10 );
...
lv_obj_set_style_text_color(ui_MixerScreen_DeckA_BPMLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckA_BPMLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckA_BPMLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_pad_left(ui_MixerScreen_DeckA_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_right(ui_MixerScreen_DeckA_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_top(ui_MixerScreen_DeckA_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_bottom(ui_MixerScreen_DeckA_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckA_WaveformLabel = lv_label_create(ui_MixerScreen_DeckA_Waveform);
...
lv_obj_set_x( ui_MixerScreen_DeckA_WaveformLabel, 2 );
lv_obj_set_y( ui_MixerScreen_DeckA_WaveformLabel, 2 );
...
lv_obj_set_style_pad_left(ui_MixerScreen_DeckB_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_right(ui_MixerScreen_DeckB_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_top(ui_MixerScreen_DeckB_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_pad_bottom(ui_MixerScreen_DeckB_Waveform, 0, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckB_WaveformLabel = lv_label_create(ui_MixerScreen_DeckB_Waveform);
...
lv_obj_set_x( ui_MixerScreen_DeckB_WaveformLabel, 2 );
lv_obj_set_y( ui_MixerScreen_DeckB_WaveformLabel, -2 );
...
ui_MixerScreen_DeckA_TotalTimeLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckA_TotalTimeLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckA_TotalTimeLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckA_TotalTimeLabel, -30 );
lv_obj_set_y( ui_MixerScreen_DeckA_TotalTimeLabel, 25 );
lv_obj_set_align( ui_MixerScreen_DeckA_TotalTimeLabel, LV_ALIGN_TOP_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckA_TotalTimeLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckA_TotalTimeLabel,"06:45");
lv_obj_set_style_text_color(ui_MixerScreen_DeckA_TotalTimeLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckA_TotalTimeLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckA_TotalTimeLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckA_TotalTimeLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckA_RemaiTimeLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckA_RemaiTimeLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckA_RemaiTimeLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckA_RemaiTimeLabel, -30 );
lv_obj_set_y( ui_MixerScreen_DeckA_RemaiTimeLabel, 10 );
lv_obj_set_align( ui_MixerScreen_DeckA_RemaiTimeLabel, LV_ALIGN_TOP_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckA_RemaiTimeLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckA_RemaiTimeLabel,"-3:22");
lv_obj_set_style_text_color(ui_MixerScreen_DeckA_RemaiTimeLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckA_RemaiTimeLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckA_RemaiTimeLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckA_RemaiTimeLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckA_KeyLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckA_KeyLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckA_KeyLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckA_KeyLabel, -5 );
lv_obj_set_y( ui_MixerScreen_DeckA_KeyLabel, 25 );
lv_obj_set_align( ui_MixerScreen_DeckA_KeyLabel, LV_ALIGN_TOP_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckA_KeyLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckA_KeyLabel,"10m");
lv_obj_set_style_text_color(ui_MixerScreen_DeckA_KeyLabel, lv_color_hex(0xD002D2), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckA_KeyLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckA_KeyLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckA_KeyLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckB_RemaiTimeLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckB_RemaiTimeLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckB_RemaiTimeLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckB_RemaiTimeLabel, -30 );
lv_obj_set_y( ui_MixerScreen_DeckB_RemaiTimeLabel, -25 );
lv_obj_set_align( ui_MixerScreen_DeckB_RemaiTimeLabel, LV_ALIGN_BOTTOM_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckB_RemaiTimeLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckB_RemaiTimeLabel,"-3:22");
lv_obj_set_style_text_color(ui_MixerScreen_DeckB_RemaiTimeLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckB_RemaiTimeLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckB_RemaiTimeLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckB_RemaiTimeLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckB_TotalTimeLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckB_TotalTimeLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckB_TotalTimeLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckB_TotalTimeLabel, -30 );
lv_obj_set_y( ui_MixerScreen_DeckB_TotalTimeLabel, -10 );
lv_obj_set_align( ui_MixerScreen_DeckB_TotalTimeLabel, LV_ALIGN_BOTTOM_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckB_TotalTimeLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckB_TotalTimeLabel,"06:45");
lv_obj_set_style_text_color(ui_MixerScreen_DeckB_TotalTimeLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckB_TotalTimeLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckB_TotalTimeLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckB_TotalTimeLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_MixerScreen_DeckB_BPMLabel, -25 );
...
lv_obj_set_style_text_color(ui_MixerScreen_DeckB_BPMLabel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_MixerScreen_DeckB_BPMLabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_align(ui_MixerScreen_DeckB_BPMLabel, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_MixerScreen_DeckB_BPMLabel, &ui_font_Inter11, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_MixerScreen_DeckB_KeyLabel = lv_label_create(ui_MixerScreen);
lv_obj_set_width( ui_MixerScreen_DeckB_KeyLabel, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_MixerScreen_DeckB_KeyLabel, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_MixerScreen_DeckB_KeyLabel, -5 );
lv_obj_set_y( ui_MixerScreen_DeckB_KeyLabel, -10 );
lv_obj_set_align( ui_MixerScreen_DeckB_KeyLabel, LV_ALIGN_BOTTOM_RIGHT );
lv_label_set_long_mode(ui_MixerScreen_DeckB_KeyLabel,LV_LABEL_LONG_CLIP);
lv_label_set_text(ui_MixerScreen_DeckB_KeyLabel,"10m");
lv_obj_set_style_text_color(ui_MixerScreen_DeckB_KeyLabel, lv_color_hex(0xD002D2), LV_PART_MAIN | LV_STATE_DEFAULT );
